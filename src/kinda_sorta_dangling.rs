...
pub(crate) struct KindaSortaDangling<T> {
...
impl<T> Deref for KindaSortaDangling<T> {
    type Target = T;
...
impl<T> DerefMut for KindaSortaDangling<T> {
    #[inline]
...
impl<T> Drop for KindaSortaDangling<T> {
    #[inline]
